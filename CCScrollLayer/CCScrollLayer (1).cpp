...
CCScrollLayer* CCScrollLayer::layerWithLayers(NSMutableArray<CCLayer*> *layers, int widthOffset)
{	
...
bool CCScrollLayer::initWithLayers(NSMutableArray<CCLayer*> *layers, int widthOffset)
{	
	if (CCLayer::init())
	{		
...
bool CCScrollLayer::ccTouchBegan(CCTouch *touch, UIEvent *withEvent)
{
...
void CCScrollLayer::ccTouchMoved(CCTouch *touch, UIEvent *withEvent)
{	
	CGPoint touchPoint = touch->locationInView(touch->view());
	touchPoint = CCDirector::sharedDirector()->convertToGL(touchPoint);
...
void CCScrollLayer::ccTouchEnded(CCTouch *touch, UIEvent *withEvent)
{
