...
protected:
	...
	virtual void onExit();
	virtual bool ccTouchBegan(CCTouch *touch, UIEvent *withEvent);
	virtual void ccTouchMoved(CCTouch *touch, UIEvent *withEvent);
	virtual void ccTouchEnded(CCTouch *touch, UIEvent *withEvent);
public:
	static CCScrollLayer* layerWithLayers(NSMutableArray<CCLayer*> *layers,int widthOffset);
	bool initWithLayers(NSMutableArray<CCLayer*> *layers,int widthOffset);
};